...
Pensez à l'équation linéaire pour l'association entre le stress thermique et la mortalité des coraux. Quel est l'augmentation attendue (ou la diminution ?) de la mortalité pour chaque augmentation d'une unité de `max_ahs` ? Quel est la valeur de $R^2$ ? La relation entre le stress thermique et la mortalité est-elle statistiquement significative ou non ?
