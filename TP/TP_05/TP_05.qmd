...
Tout cela était amusant, mais jusqu'à présent, nous ne savons pas si les modèles sont « valides » et si les trois hypothèses principales sont respectées. Mais avant de vérifier les modèles que nous avons utilisés dans le TP 4, comprenons mieux ce que signifie chaque hypothèse.
